...
class WashAndCoat extends StatefulWidget {
  const WashAndCoat({super.key});

  @override
  State<WashAndCoat> createState() => _WashAndCoatState();
}

class _WashAndCoatState extends State<WashAndCoat> {
  List<Service> Services = [
    Service(
       price: 449,
      Name: 'Hybrid Ceramic & \n Interior with underbody',
      imageURL: 'asset/wash&coat1.jpg',
      time: '90 mins',
