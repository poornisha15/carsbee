...
class EngineClean extends StatefulWidget {
  const EngineClean({super.key});

  @override
  State<EngineClean> createState() => _EngineCleanState();
}

class _EngineCleanState extends State<EngineClean> {
  List<Service> Services = [
    Service(
      price: 589,
      Name: 'Engine Clean Only',
      imageURL: 'asset/engine1.jpg',
      time: '60 mins',
