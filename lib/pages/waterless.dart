...
class Waterlessclean extends StatefulWidget {
  const Waterlessclean({super.key});

  @override
  State<Waterlessclean> createState() => _WaterlesscleanState();
}

class _WaterlesscleanState extends State<Waterlessclean> {
  List<Service> Services = [
    Service(
      price: 389,
      Name: 'WaterLess Interior Only',
      imageURL: 'asset/waterless2.jpg',
      time: '60 mins',
      description: 'A waterless car wash uses high \nlubricant spray to clean.'
    ),
    Service(
      price: 339,
      Name: 'WaterLess Exterior Only',
      imageURL: 'asset/waterless1.jpg',
      time: '50 mins',
      description: 'A waterless car wash uses high \nlubricant spray to clean.'
    ),
    Service(
      price: 639,
      Name: 'WaterLess Exterior &\n Interior',
      imageURL: 'asset/waterless3.jpg',
      time: '90 mins',
